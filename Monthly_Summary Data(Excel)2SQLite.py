...
It was written to read in the data from 2003-2013. During this period, the 
SST data was combined with the SeaIce data. This script splits off the SST
data and makes a new column for it.

It's easier to use the Excel files than it is to use the ASCII files. There
are more errors in the ASCII files that are difficult to rogram around.
...
yeararr = np.arange(2013,2014,1)
montharr = np.arange(9,10,1)
